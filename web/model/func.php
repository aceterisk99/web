...
function addDiary($diarydatecreated,$diary_label,$diary_status)
{
		$db = db();		
		$sql = "INSERT INTO diaries (diary_datecreated,diary_label,diary_status) VALUES (?,?,?)";
		$s=$db->prepare($sql);
		$s->execute(array($diarydatecreated,$diary_label,$diary_status));
		$db = null;
}
/*function viewDiary()
	{
